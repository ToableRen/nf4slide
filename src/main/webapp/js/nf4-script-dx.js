...
function addCodeToSlide(id) {
    ...
    $("#nf4-code-" + idExtend).contextPopup({
        ...
        items: [
            {
                label: '删除此代码框', icon: 'http://120.24.186.116/Myicons/nf4-view-delete.png', action: function () {
                $("#nf4-code-" + idExtend).remove();
            }
            },
            {
                label: '层次:置顶', icon: 'http://120.24.186.116/Myicons/nf4-view-up.png', action: function () {
                $("#nf4-code-" + idExtend).css('z-index', searchMaxZindex() + 1);
            }
            },
            //null, /* null can be used to add a separator to the menu items */
            {
                label: '层次:置底', icon: 'http://120.24.186.116/Myicons/nf4-view-down.png', action: function () {
