package com.qtu404.present.unit;
...
public class ImageDeal {
    public final static String userAvatorUrl = "avator";
    private final static String avatorName = "user.jpg";

    public static String getUserAvatorUrl(String userId) {
        return userAvatorUrl + File.separator + userId + File.separator + avatorName;
    }

    public static String getAvatorPath(String rootPath, String userId) {
