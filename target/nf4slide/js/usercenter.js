...
function addAPPT(workplace, id, name) {
	...
	if (IsPC()) {
		...
		$("#pptEdit-" + ExId).click(function() {
			window.open("edit.jsp?slideId=" + id, "_blank");
		});
	}
	...
	$("#pptPlay-" + ExId).click(function() {
		window.open("Play.jsp?slideId=" + id + "&userId=" + userId, "_blank");
	});
	...
	$("#pptSpeak-" + ExId).click(function() {
		window.open("Play.jsp?slideId=" + id + "&userId=" + userId+"&control=true", "_blank");
	});
